...
const MenuDrawer = ({ isOpen }: MenuDrawerProps) => {
  ...
  return (
    <>
      <div
        className={`fixed top-[100px] left-0 h-[calc(100vh-100px)] w-full sm:w-[400px] bg-[#F7F6F0] z-50 shadow-2xl transform transition-transform duration-300 ease-in-out overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent hover:scrollbar-thumb-gray-500 ${
